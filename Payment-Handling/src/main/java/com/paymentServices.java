...
public class paymentServices {
	...
	@Consumes(MediaType.APPLICATION_FORM_URLENCODED) 
	@Produces(MediaType.TEXT_PLAIN) 
	public String createCard(@FormParam("cardNumber") String cardNumber, @FormParam("acntNumber") String acntNumber, @FormParam("expiry") String expiry, @FormParam("CVC") String CVC) { 
